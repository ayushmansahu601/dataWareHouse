...
BEGIN
    ...
    BEGIN TRY
		...
		-- Loading second.crm_cust_info
        SET @start_time = GETDATE();
		PRINT '>> Truncating Table: second.crm_cust_info';
		TRUNCATE TABLE second.crm_cust_info;
		PRINT '>> Inserting Data Into: second.crm_cust_info';
		...
		-- Loading second.crm_prd_info
        SET @start_time = GETDATE();
		PRINT '>> Truncating Table: second.crm_prd_info';
		TRUNCATE TABLE second.crm_prd_info;
		PRINT '>> Inserting Data Into: second.crm_prd_info';
        ...
        SET @start_time = GETDATE();
		PRINT '>> Truncating Table: second.crm_sales_details';
		TRUNCATE TABLE second.crm_sales_details;
		PRINT '>> Inserting Data Into: second.crm_sales_details';
        ...
        SET @start_time = GETDATE();
		PRINT '>> Truncating Table: second.erp_cust_az12';
		TRUNCATE TABLE second.erp_cust_az12;
		PRINT '>> Inserting Data Into: second.erp_cust_az12';
        ...
        SET @start_time = GETDATE();
		PRINT '>> Truncating Table: second.erp_loc_a101';
		TRUNCATE TABLE second.erp_loc_a101;
		PRINT '>> Inserting Data Into: second.erp_loc_a101';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Table: second.erp_px_cat_g1v2';
		TRUNCATE TABLE second.erp_px_cat_g1v2;
		PRINT '>> Inserting Data Into: second.erp_px_cat_g1v2';
		...
		PRINT '=========================================='
		PRINT 'Loading second Layer is Completed';
